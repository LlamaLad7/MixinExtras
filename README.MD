...
```gradle
dependencies {
    implementation(jarJar("io.github.llamalad7:mixinextras-neoforge:0.5.1"))
}
```
...
```gradle
dependencies {
    compileOnly(annotationProcessor("io.github.llamalad7:mixinextras-common:0.5.1"))
    implementation(jarJar("io.github.llamalad7:mixinextras-forge:0.5.1")) {
        jarJar.ranged(it, "[0.5.1,)")
    }
}
```
...
dependencies {
    compileOnly(annotationProcessor("io.github.llamalad7:mixinextras-common:0.5.1"))
    implementation(include("io.github.llamalad7:mixinextras-forge:0.5.1"))
}
```
...
dependencies {
    shadow(annotationProcessor("io.github.llamalad7:mixinextras-common:0.5.1"))
}
