...
```gradle
dependencies {
    include(implementation(annotationProcessor("io.github.llamalad7:mixinextras-fabric:0.5.5")))
}
```
...
```gradle
dependencies {
    implementation(jarJar("io.github.llamalad7:mixinextras-neoforge:0.5.5"))
}
```
...
<details><summary>Forge 1.18.2+ with ForgeGradle or ModDevGradle</summary>
...
dependencies {
    compileOnly(annotationProcessor("io.github.llamalad7:mixinextras-common:0.5.5"))
    implementation(include("io.github.llamalad7:mixinextras-forge:0.5.5"))
}
```
...
dependencies {
    shadow(annotationProcessor("io.github.llamalad7:mixinextras-common:0.5.5"))
}
