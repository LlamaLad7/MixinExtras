...
```gradle
dependencies {
    implementation(jarJar("io.github.llamalad7:mixinextras-neoforge:0.5.2"))
}
```
...
dependencies {
    ...
    implementation(jarJar("io.github.llamalad7:mixinextras-forge:0.5.2")) {
        jarJar.ranged(it, "[0.5.2,)")
    }
}
```
...
dependencies {
    compileOnly(annotationProcessor("io.github.llamalad7:mixinextras-common:0.5.2"))
    implementation(include("io.github.llamalad7:mixinextras-forge:0.5.2"))
}
```
...
dependencies {
    shadow(annotationProcessor("io.github.llamalad7:mixinextras-common:0.5.2"))
}
